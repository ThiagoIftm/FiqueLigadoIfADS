...
public class Evento {
    ...
    public Evento(Integer id, String nome, LocalDate dataInicio, LocalDate dataFim, String linkBanner, StatusEnum status, Double valorInscricao, Usuario responsavel, Usuario cadastradoPor){
